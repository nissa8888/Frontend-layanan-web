<!-- Modal contact -->
<div class="modal fade bd-example-modal-lg" id="pesan<?php echo $data['id']; ?>" tabindex="-1" role="dialog"
        ...
        <form role="form" method="post">
          ...
          <div role="form" class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="barang" id="nama" value="<?php echo $data['nama']; ?>"
                readonly>
            </div>
            <div class="form-group col-md-6">
...
if (isset($_POST['kirim'])) {
  ...
  $alamat = $_POST['alamat'];
  $pesan = $_POST['pesan'];
  echo "<script>window.location.href = 'https://api.whatsapp.com/send?phone=+6285703697595&text=saya ingin membeli%0A$barang%0A%0Acatatan pesanan:%0ANama: $pembeli%0AEmail: $email%0AAlamat: $alamat%0Acatatan untuk penjual:%0A$pesan';</script>";
}
?>